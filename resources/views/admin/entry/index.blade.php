                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'survey_id'">{{ trans('admin.entry.columns.survey_id') }}</th>
                                        <th is='sortable' :column="'participant_id'">{{ trans('admin.entry.columns.participant_id') }}</th>
